        ...
        <div class="container">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home"
                            type="button" role="tab" aria-controls="home" aria-selected="true">Account Details
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile"
                            type="button" role="tab" aria-controls="profile" aria-selected="false">Add Customer
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact"
                            type="button" role="tab" aria-controls="contact" aria-selected="false">Remove Customer
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#credit"
                            type="button" role="tab" aria-controls="credit" aria-selected="false">Credit Funds
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#debit" type="button"
                            role="tab" aria-controls="debit" aria-selected="false">Debit Funds
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#transfer"
                            type="button" role="tab" aria-controls="transfer" aria-selected="false">Transfer Funds
                    </button>
                </li>
            </ul>
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <form action="" method="post">
                        <div class="input-group input-group-lg mb-3">
                            ...
                            <button class="btn btn-outline-secondary" name="findcustomer" type="submit"
                                    id="button-addon2">Find Details
                            </button>
                        </div>
                    </form>
                    <?php
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <form class="row g-3 m-4" id="printCustomerDetail">
                                ...
                                <div class="input-group justify-content-center">
                                    <button class="btn btn-outline-danger d-grid gap-2 col-4 mx-auto" type="button"
                                            onclick="printDiv('printCustomerDetail')"> Print
                                    </button>
                                </div>
                            </form>
                            <?php
                ...
                <div class="tab-pane fade m-5" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <form class="row g-3" action="../forms/add-customer.php" method="post"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" value="Female" name="flexRadioDefault"
                                       id="flexRadioDefault1">
                ...
                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                    ...
                    <form action="" method="post">
                        <div class="input-group input-group-lg mb-3">
                            <input type="number" class="form-control" placeholder="Account Number" name="accnum"
                                   aria-label="Recipient's username" aria-describedby="button-addon2">
                            <button class="btn btn-outline-danger" name="removeC" type="submit" id="button-addon2">
                                Remove Customer
                            </button>
                        </div>
                    </form>
                    ...
                    <center class="m-4"><h3>Credit Funds</h3>
                        ...
                        <form action="../forms/credit-fund.php" method="post">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <input type="submit" name="creditfund" class="btn btn-primary btn-lg"
                                           value="Credit fund">
                                </div>
                            </div>
                        </form>
                    ...
                    <center class="m-4"><h3>Debit Funds</h3>
                        ...
                        <form action="../forms/debit-fund.php" method="post">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <input type="submit" name="debitfund" class="btn btn-primary btn-lg"
                                           value="Debit fund">
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="number" name="fromaccount" class="form-control"
                                           aria-label="Sizing example input" required
                                           aria-describedby="inputGroup-sizing-lg">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="number" name="toaccount" class="form-control"
                                           aria-label="Sizing example input" required
                                           aria-describedby="inputGroup-sizing-lg">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4 mt-4 d-flex justify-content-center">
                                ...
                                <input type="submit" name="transferfund" class="btn btn-primary btn-lg"
