                    ...
                    <div id="main-id" class="col-sm-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 " id="info"><br>
                                <b>Name&nbsp;&nbsp;:</b>&nbsp;<?php echo $_POST['firstname'] . " " . $_POST['fathername'] . " " . $_POST['lastname']; ?>
                                <br>
                                <b>Employee
                                    ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b>&nbsp;&nbsp;&nbsp;<b><?php echo $_POST['empid']; ?></b><br>
                                <b>DOB&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b>&nbsp;&nbsp;&nbsp;<?php echo $_POST['dob']; ?>
                                <br>
                                <b>Mobile
                                    No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b>&nbsp;&nbsp;&nbsp;<?php echo $_POST['mobileno']; ?>
                                <br>
                                <b>Qualification&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b>&nbsp;&nbsp;&nbsp;<?php echo $_POST['qualification']; ?>
                                <br>
