        ...
        if ($result) {
            ...
            if ($email == $fetch_manager_result['email']) {
                ...
                if ($password == $fetch_manager_result['pass']) {
                    ...
                    echo "<script> alert('Wrong Credentials!'); window.location.href='../forms/login.php';</script>";
...
if (isset($_POST['emplogin'])) {
    ...
    if ($responseData->success) {
        ...
        if ($result) {
            ...
            if ($email == $fetch_employee_result['email_address']) {
                ...
                if ($check_password_hash) {
                    ...
                    echo "<script> alert('Wrong Credentials!'); window.location.href='../forms/register.php';</script>";
        ...
        //if user is a robot
        echo "<script> alert('You are robot. Stop doing this!'); window.location.href='../forms/register.php'; </script>";
