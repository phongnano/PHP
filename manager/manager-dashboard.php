...
<header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                <li><a class="nav-link scrollto active" href="../index.php#hero">Trang chủ</a></li>
                <li><a class="nav-link scrollto" href="../index.php#about">Giới thiệu</a></li>
                <li><a class="nav-link scrollto" href="../index.php#services">Thông báo</a></li>
                <li><a class="nav-link scrollto" href="../index.php#team">Nhóm</a></li>
                <li><a class="nav-link scrollto" href="../index.php#contact">Liên hệ</a></li>
            </ul>
    ...
    <section class="breadcrumbs">
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h2>Chào mừng <strong style="color: chocolate;"><?php echo $_SESSION['fullname']; ?></strong></h2>
                <a href="../backend/manager-logout.php"><h5>Đăng xuất</h5></a>
            </div>
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <section style="height:100%;">
                        ...
                        <div class="row">
                            <center><h2><b>CHI TIẾT NHÂN VIÊN</b></h2></center>
                            ...
                            <div class="col-sm-10">
                                <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                                ...
                                                aria-selected="true">Find Employee
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                                ...
                                                aria-selected="false">Add Employee
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                                ...
                                                aria-selected="false">Remove Employee
                                        </button>
                                    </li>
                                </ul>
                                <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <div class="tab-pane fade m-5" id="pills-profile" role="tabpanel"
                                    ...
                                    <div class="tab-pane fade" id="pills-contact" role="tabpanel"
                                        ...
                                        <form action="" method="post">
                                            <div class="input-group input-group-lg mb-3 ">
                                                ...
                                                <button class="btn btn-outline-danger" type="submit" name="removeemp"
                                                        id="button-addon2">Remove Employee
                                                </button>
                                            </div>
                                        </form>
                                        <?php
